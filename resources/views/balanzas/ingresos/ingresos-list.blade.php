        ...
        <div class="contenedor">
            <div class="central">
                ...
                <span class="receipt-label text-large distancia">Patente: </span> <span class="text-large">{{ $ticketEntrada->patente }} <br></span>
                    {{--<span class="receipt-label text-large distancia">Chofer: </span> <span class="text-large">{{ $ticketEntrada->chofer_id }}
                    <br></span>--}}
                ...
                <span class="receipt-label text-large distancia">Neto: </span> <span class="text-large">{{ $ticketEntrada->neto }} Kg <br></span>
                    {{--<span class="receipt-label text-large distancia">Inicio actividad: </span> <span
                    class="text-large">{{ $ticketEntrada->fecha_inicio_actividades }} <br></span>--}}
            </div>
        </div>
            {{--@endforeach--}}
        <div class="footer">
