<head>
    <title>Informe de ordenes de produccion</title>
    ...
    <div class="mt-5 row justify-content-center">
        <table class="table table-striped col-md-10">
            ...
            @if (sizeof($informe['prodMasFreq']) > 0)
                ...
                <tr>
                    <td>Cliente dueño</td>
                    <td>{{$informe['prodMasFreq'][0]->denominacion}}</td>
                </tr>

                <tr>
                    <td>Veces vendido</td>
                    <td>{{$informe['prodMasFreq'][0]->count}}</td>
                </tr>

                <tr>
                    <td>Cantidad vendida</td>
                    <td>{{$informe['prodMasFreq'][0]->suma}} kgs.</td>
                </tr>
                ...
                <tr>
                    <td>Cliente dueño</td>
                    <td>{{$informe['prodMasKgs'][0]->denominacion}}</td>
                </tr>

                <tr>
                    <td>Veces vendido</td>
                    <td>{{$informe['prodMasKgs'][0]->count}}</td>
                </tr>

                <tr>
                    <td>Cantidad vendida</td>
                    <td>{{$informe['prodMasKgs'][0]->suma}} kgs.</td>
                </tr>
            @endif
            </tbody>
        </table>
