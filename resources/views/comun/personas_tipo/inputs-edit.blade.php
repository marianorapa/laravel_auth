...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="nro_documento" type="text" class="form-control" name="nro_documento" value="{{$personaTipo->nro_documento}}" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="email" type="tel" class="form-control" name="email" value="{{$personaTipo->email}}" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="observaciones" type="text" class="form-control" value="{{$personaTipo->observaciones}}" name="observaciones">
    </div>
</div>
