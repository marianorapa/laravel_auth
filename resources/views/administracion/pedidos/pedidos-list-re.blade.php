...
{{--    </div>--}}
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-8">
            <h2>Informe de Órdenes de producción</h2>
        ...
        <table class="table">
            ...
            @foreach ($pedidos as $op)
                <tr>
                    ...
                    <td id="producto">{{$op->fecha_fabricacion}}</td>
                    <td id="producto">{{$op->empresa}}</td>
                    <td id="cantidad">{{$op->producto}}</td>
                    <td id="cantidad">{{$op->cantidad}}</td>
                    <td id="cantidad">{{$op->descripcion}}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
